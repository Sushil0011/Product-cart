...
const removehandler=(id)=>{
  ...
  <div  className='h-[100vh] flex flex-col gap-[2rem] box-border w-screen items-center bg-slate-400  py-[10px] px-[2rem]'>
...
cartdata.map((elem,index)=>{
  ...
  return(
    ...
    <div   className='flex  max-w-[1200px] rounded-[4px] w-[90vw] bg-white items-center md:justify-between   flex-col gap-[10px] md:px-[1rem] lg:px-[4rem]    px-[10px]  py-[10px]'>
